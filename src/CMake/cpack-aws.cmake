...
if (${LINUX_FLAVOR} STREQUAL Ubuntu)
  ...
  SET(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_BINARY_DIR}/postinst-aws;${CMAKE_CURRENT_BINARY_DIR}/prerm-aws")
...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS)")
  ...
  SET(CPACK_RPM_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/postinst-aws")
  SET(CPACK_RPM_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/prerm-aws")
...
SET(CPACK_PACKAGE_CONTACT "ryan.radjabi@xilinx.com")
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "AWS Plugin to Xilinx RunTime stack for use with Xilinx FPGA platforms")
