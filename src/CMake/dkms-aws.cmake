...
foreach(DKMS_FILE ${XRT_DKMS_SRCS_aws})
  ...
  install(FILES ${XRT_DKMS_DRIVER_SRC_BASE_DIR}/${DKMS_FILE}
          DESTINATION ${XRT_DKMS_INSTALL_DIR_aws}/${DKMS_DIR}
          COMPONENT aws)
  list(APPEND XRT_DKMS_ABS_SRCS_aws ${XRT_DKMS_DRIVER_SRC_BASE_DIR}/${DKMS_FILE})
endforeach()

install(FILES ${CMAKE_CURRENT_BINARY_DIR}/xrt-aws-prep/${DKMS_FILE_NAME}
        DESTINATION ${XRT_DKMS_INSTALL_DIR_aws}
        COMPONENT aws)
